package com.airletnet.mobile.svprogresshud;
...
import com.airletnet.mobile.svprogresshud.listener.OnDismissListener;
import com.airletnet.mobile.svprogresshud.view.SVCircleProgressBar;
import com.airletnet.mobile.svprogresshud.view.SVProgressDefaultView;
...
public class SVProgressHUD {
    ...
    public void showImageWithStatus(int res,String string){
        if(isShowing())return;
        setMaskType(SVProgressHUDMaskType.Black);
        mSharedView.showBaseStatus(res,string);
        svShow();
        scheduleDismiss();
    }

    public void showDefaultWithStatus(String string){
        if(isShowing())return;
        setMaskType(SVProgressHUDMaskType.Black);
        mSharedView.showWithStatus(string);
        svShow();
    ...
    public SVProgressHUD setText(String string){
    ...
    public SVProgressHUD setOnDismissListener(OnDismissListener listener){
