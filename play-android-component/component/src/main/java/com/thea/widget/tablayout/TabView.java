...
public class TabView extends LinearLayout {
    ...
    private void init() {
        ...
        setBackground(getResources().getDrawable(mTabLayout.getTabBackgroundResId()));
...
//            mTextView.setTextAppearance(mTabLayout.getTabTextAppearance());
    ...
    public static final class Tab {
        ...
        public Tab(Context context, int iconResId, CharSequence text) {
            this(context, context.getResources().getDrawable(iconResId) /**TintManager.getDrawable(context, iconResId)*/, text);
        }
        ...
        public Tab(Context context, int iconResId, int textResId) {
            this(context, context.getResources().getDrawable(iconResId) /**TintManager.getDrawable(context, iconResId)*/, textResId);
        }
