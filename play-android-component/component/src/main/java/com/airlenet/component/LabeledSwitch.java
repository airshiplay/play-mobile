...
public class LabeledSwitch extends View {
    ...
    private int desiredWidth = Math.round(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 72, getResources().getDisplayMetrics()));
    private int desiredHeight = Math.round(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 32, getResources().getDisplayMetrics()));
...
//        }
        colorBorder = colorOn =  defaultColor;
        paint = new Paint();
...
//                int accentColor;
//                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
//                    accentColor =defaultColor; getResources().getColor(R.color.colorAccent, getContext().getTheme());
//                } else {
//                    accentColor =defaultColor; getResources().getColor(R.color.colorAccent);
//                }
                colorBorder = tarr.getColor(R.styleable.Toggle_colorBorder, defaultColor);
...
//                }
                colorOn = tarr.getColor(R.styleable.Toggle_colorOn, defaultColor);
