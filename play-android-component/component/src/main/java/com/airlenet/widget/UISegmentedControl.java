...
public class UISegmentedControl extends RadioGroup implements OnCheckedChangeListener {
    ...
    public UISegmentedControl(Context context, AttributeSet attrs) {
        ...
        a.recycle();
        a = context.obtainStyledAttributes(attrs, R.styleable.segmentedControl);
        setTextColor(a.getColorStateList(R.styleable.segmentedControl_android_textColor));
        setTextArray(a.getTextArray(R.styleable.segmentedControl_sw_textArray));
        setSwitchCount(a.getInteger(R.styleable.segmentedControl_sw_switchCount, DEFAULT_SWITCH_COUNT));
        setSwitchStyle(a.getResourceId(R.styleable.segmentedControl_sw_ThemeStyle, 0));
        setCornerRadius(a.getDimension(R.styleable.segmentedControl_sw_CornerRadius, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 5f, getResources().getDisplayMetrics())));
        setCheckedColor(a.getColor(R.styleable.segmentedControl_sw_checkedColor, Color.GREEN));
        setUnCheckedColor(a.getColor(R.styleable.segmentedControl_sw_unCheckedColor, Color.WHITE));
        setStrokeColor(a.getColor(R.styleable.segmentedControl_sw_strokeColor, Color.GREEN));
        setStrokeWidth((int) a.getDimension(R.styleable.segmentedControl_sw_strokeWidth, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 1f, getResources().getDisplayMetrics())));
        setTextSize(a.getDimension(R.styleable.segmentedControl_android_textSize, 0f));
        a.recycle();
