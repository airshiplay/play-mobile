...
public class LabelInputView extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int input_gravity = array.getInt(
                R.styleable.input_view_input_inputGravity, 0);
        ...
        if (input_gravity != 0)
            inputView.setGravity(Gravity.RIGHT);
    ...
    public void setInputPaddingRight(int paddingRight) {
        inputView.setPadding(inputView.getPaddingLeft(),
                inputView.getPaddingTop(), paddingRight,
                inputView.getPaddingBottom());
    }
