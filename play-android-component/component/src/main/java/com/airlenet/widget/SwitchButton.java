    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (stateDrawable != null && stateMaskDrawable != null) {
            ...
            if (stateMaskDrawable != null && stateBitmap != null && !stateBitmap.isRecycled()) {
                ...
                @SuppressLint("WrongConstant") int src = canvas.saveLayer(0, 0, getWidth(), getHeight(), paint, Canvas.MATRIX_SAVE_FLAG | Canvas.CLIP_SAVE_FLAG | Canvas.HAS_ALPHA_LAYER_SAVE_FLAG | Canvas.FULL_COLOR_LAYER_SAVE_FLAG | Canvas.CLIP_TO_LAYER_SAVE_FLAG);
                // 绘制遮罩层
