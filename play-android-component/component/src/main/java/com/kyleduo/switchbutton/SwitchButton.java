...
public class SwitchButton extends CompoundButton {
	...
	private void init(AttributeSet attrs) {
		...
		TypedArray ta = attrs == null ? null : getContext().obtainStyledAttributes(attrs, R.styleable.SwitchButton11);
		if (ta != null) {
			thumbDrawable = ta.getDrawable(R.styleable.SwitchButton11_kswThumbDrawable);
			thumbColor = ta.getColorStateList(R.styleable.SwitchButton11_kswThumbColor);
			margin = ta.getDimension(R.styleable.SwitchButton11_kswThumbMargin, margin);
			marginLeft = ta.getDimension(R.styleable.SwitchButton11_kswThumbMarginLeft, margin);
			marginRight = ta.getDimension(R.styleable.SwitchButton11_kswThumbMarginRight, margin);
			marginTop = ta.getDimension(R.styleable.SwitchButton11_kswThumbMarginTop, margin);
			marginBottom = ta.getDimension(R.styleable.SwitchButton11_kswThumbMarginBottom, margin);
			thumbWidth = ta.getDimension(R.styleable.SwitchButton11_kswThumbWidth, thumbWidth);
			thumbHeight = ta.getDimension(R.styleable.SwitchButton11_kswThumbHeight, thumbHeight);
			thumbRadius = ta.getDimension(R.styleable.SwitchButton11_kswThumbRadius, Math.min(thumbWidth, thumbHeight) / 2.f);
			backRadius = ta.getDimension(R.styleable.SwitchButton11_kswBackRadius, thumbRadius + density * 2f);
			backDrawable = ta.getDrawable(R.styleable.SwitchButton11_kswBackDrawable);
			backColor = ta.getColorStateList(R.styleable.SwitchButton11_kswBackColor);
			backMeasureRatio = ta.getFloat(R.styleable.SwitchButton11_kswBackMeasureRatio, backMeasureRatio);
			animationDuration = ta.getInteger(R.styleable.SwitchButton11_kswAnimationDuration, animationDuration);
			fadeBack = ta.getBoolean(R.styleable.SwitchButton11_kswFadeBack, true);
			tintColor = ta.getColor(R.styleable.SwitchButton11_kswTintColor, tintColor);
			textOn = ta.getString(R.styleable.SwitchButton11_kswTextOn);
			textOff = ta.getString(R.styleable.SwitchButton11_kswTextOff);
			textMarginH = ta.getDimension(R.styleable.SwitchButton11_kswTextMarginH, textMarginH);
			ta.recycle();
		}
